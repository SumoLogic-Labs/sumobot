...
3. Make a release branch with Scala version and project version, ex. `sumobot-1.0.15`:
    ```
    export RELEASE_VERSION=sumobot-1.0.15
...
in `build.gradle`, ex. `1.0.16-SNAPSHOT`
