...
3. Make a release branch with Scala version and project version, ex. `sumobot-1.0.16`:
    ```
    export RELEASE_VERSION=sumobot-1.0.16
...
in `build.gradle`, ex. `1.0.17-SNAPSHOT`
