...
3. Make a release branch with Scala version and project version, ex. `sumobot-1.0.13`:
    ```
    export RELEASE_VERSION=sumobot-1.0.13
...
in `build.gradle`, ex. `1.0.13-SNAPSHOT`
