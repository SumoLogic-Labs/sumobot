...
3. Make a release branch with Scala version and project version, ex. `sumobot-1.0.14`:
    ```
    export RELEASE_VERSION=sumobot-1.0.14
...
in `build.gradle`, ex. `1.0.14-SNAPSHOT`
