...
class ChannelTest
  ...
  private val channel = new SlackChannel("C123", "slack_test", 1, Some(self.id), Some(false), Some(true), Some(false), None, None, None, None, None, None, None, None, None, None, None)
